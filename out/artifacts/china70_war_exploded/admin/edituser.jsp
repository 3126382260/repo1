...
<head>
  ...
  <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/admin/images/favicon.png">
  <link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath}/admin/images/app-icon72x72@2x.png">
...
<!--/end  -->
  ...
  <div class="admin-content">
    ...
    <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/editeuserUp" method="post" onsubmit="return isSubmit()">
            <input type="hidden" name="u_id" value="${ub.u_id}">
            <div class="am-form-group">
              <label class="am-u-sm-3 am-form-label">账号</label>
              <div class="am-u-sm-6">
                <input value="${ub.u_user}"  maxlength="12"  readonly type="text" name="u_use" id="u_user" onfocus="showTips('账号不能为空','err_u_use')" onkeyup="user_userKey()" onblur="user_userKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input value="${ub.u_pwd}" maxlength="12" type="password" name="u_pwd" id="u_pwd" onfocus="showTips('密码不能为空','err_u_pwd')" onkeyup="user_pwdKey()" onblur="user_pwdKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input value="${ub.u_name}" maxlength="12"  type="text" id="u_name" name="u_name" onfocus="showTips('姓名不能为空','err_u_name')" onkeyup="user_name()" onblur="user_name()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input value="${ub.u_email}" maxlength="19"  type="email"  name="u_email" id="u_email" onfocus="showTips('邮箱不能为空','user_email')" onkeyup="user_email()" onblur="user_userKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input value="${ub.u_phone}" maxlength="18"  type="tel" id="u_phone" name="u_phone" onfocus="showTips('电话不能为空','err_u_phone')" onkeyup="user_phone()" onblur="user_phone()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input value="${ub.u_qq}" maxlength="12" type="text" name="u_qq" id="u_qq" onfocus="showTips('QQ号码不能为空','err_u_qq')" onkeyup="user_qqKey()" onblur="user_qqKey()">
