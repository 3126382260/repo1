  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">分类信息修改</strong></div>
      </div>
      <hr/>
      <div class="am-g">
        <div class="am-u-sm-12 am-u-md-12  am-u-md-pull-12 ">
          <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/editNav" method="post" onsubmit="return isSubmit()">
            <input type="hidden" name="n_id" value="${nb.n_id}">
            <div class="am-form-group">
              <label class="am-u-sm-3 am-form-label">分类名称</label>
              <div class="am-u-sm-6">
                <input type="text" name="n_name" value="${nb.n_name}" id="n_name" onfocus="showTips('分类名称不能为空','err_n_name')" onblur="nav_nameKey()" onkeyup="nav_nameKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input type="text" id="en_n_name" value="${nb.en_n_name}" name="en_n_name"  onfocus="showTips('分类名称不能为空','err_en_n_name')" onblur="en_nav_nameKey()" onkeyup="en_nav_nameKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input type="text" id="n_introduce" value="${nb.n_introduce}" name="n_introduce"  onfocus="showTips('分类介绍不能为空','err_n_introduce')" onblur="nav_n_introduceKey()" onkeyup="nav_n_introduceKey()">
           ...
           <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input type="text" name="n_alias" value="${nb.n_alias}" id="n_alias"  onfocus="showTips('别名不能为空','err_n_alias')" onblur="nav_n_aliasKey()" onkeyup="nav_n_aliasKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input type="text" name="n_feight" value="${nb.n_feight}" id="n_feight"  onfocus="showTips('排序权重不能为空','err_n_feight')" onblur="nav_feightKey()" onkeyup="nav_feightKey()">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-6">
                <input type="text" name="n_url" id="n_url" value="${nb.n_url}"  onfocus="showTips('路径不能为空','err_n_url')" onblur="nav_urlKey()" onkeyup="nav_urlKey()">
